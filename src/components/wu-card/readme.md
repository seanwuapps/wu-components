...
| ----------- | ------------ | ----------------------------------------------------------------------------------------------- | --------- |
| `alt`       | `alt`        | Card image alt text                                                                             | `string`  |
| `cardTitle` | `card-title` | Title of the card                                                                               | `string`  |
| `flat`      | `flat`       | If this card has flat (border) style                                                            | `boolean` |
| `hover`     | `hover`      | If this card is hoverable                                                                       | `boolean` |
